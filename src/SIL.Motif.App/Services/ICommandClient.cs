...
/// for <see cref="ListKnownProjectsAsync"/> and <see cref="GetCurrentBaselineAsync"/>, which are queries
/// with no CLI verb — the equivalent read. A view model never shells out to the CLI and never parses
/// JSON; <see cref="CommandClient"/> runs everything in-process, and a deterministic fake stands in for
/// it in tests.
/// </summary>
